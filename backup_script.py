...
class BackupManager:
    def __init__(self, project_root=None, backup_destination=None):
        ...
        if backup_destination is None:
            ...
            # Validate backup destination path (allow absolute paths)
            self.backup_destination = validate_path_safe(self.project_root, backup_destination, allow_absolute=True)
