...
def test_skill_loading():
    ...
    print("First 200 chars of injected prompt:")
    ...
    print(
        f"SWE-compliance injected: {'swe-compliance' in injected_reviewer.lower() or 'compliance' in injected_reviewer.lower()}"
    )
    print("First 200 chars of injected prompt:")
    ...
    print(
        f"Reviewer dispatch triggers swe-compliance: {'compliance' in injected_reviewer.lower()}"
    )
