...
class HealthChecker:
    ...
    def check_skills_directory(self) -> HealthCheckResult:
        ...
        if skill_count == 0:
            return HealthCheckResult(
                ...
                details={"skills_dir": str(skills_dir), "skill_count": 0},
            )
        ...
        return HealthCheckResult(
            ...
            details={"skills_dir": str(skills_dir), "skill_count": skill_count},
        )
    ...
    def check_workflows_directory(self) -> HealthCheckResult:
        ...
        if len(workflow_files) == 0:
            return HealthCheckResult(
                ...
                details={"workflows_dir": str(workflows_dir), "workflow_count": 0},
            )
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                return HealthCheckResult(
                    ...
                    details={"devin_cli_path": devin_cli_path, "version": version},
                )
            else:
                return HealthCheckResult(
                    component="devin_cli",
            ...
            return HealthCheckResult(
                ...
                details={"devin_cli_path": devin_cli_path, "error": str(e)},
            )
    ...
    def print_report(self, report: dict):
        ...
        print(
            f"Summary: {summary['healthy']} healthy, {summary['warning']} warnings, {summary['error']} errors"
        )
        print()
