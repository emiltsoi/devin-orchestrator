...
class TestTriageEvaluator(unittest.TestCase):
    ...
    def test_evaluate_stage_and_triage_retry_on_validation_error(self):
        ...
        result = self._result()
        validation = {"valid": False, "errors": ["bad artifact"], "artifact_results": {}}
    ...
    def test_skip_stage_proceed(self):
        ...
        stage = {"name": "brainstorming", "skill": "brainstorming", "output_artifacts": ["design.md"]}
    ...
    def test_skip_stage_no_artifacts(self):
        ...
        stage = {"name": "brainstorming", "skill": "brainstorming", "output_artifacts": []}
