...
class TestCheckConfigFile:
    def test_healthy_config(self, tmp_path):
        ...
        with (
            patch(
                "devin_orchestrator.health_check.ConfigLoader.load",
    ...
    def test_missing_config_file(self, tmp_path):
        ...
        with (
            ...
            patch(
                "devin_orchestrator.health_check.ConfigLoader.FALLBACK_CONFIG_PATH",
                missing,
            ),
        ):
            result = checker.check_config_file()
...
class TestCheckDevinCli:
    ...
    def test_cli_version_ok(self, tmp_path):
        ...
        with patch("devin_orchestrator.health_check.subprocess.run") as mock_run:
    ...
    def test_cli_timeout_is_error(self, tmp_path):
        ...
        with patch(
            "devin_orchestrator.health_check.subprocess.run",
