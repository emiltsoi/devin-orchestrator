...
from devin_orchestrator.config_loader import (
...
class TestLoadConfig:
    ...
    def test_fallback_to_local_dirs_when_paths_missing(self, tmp_path):
        ...
        assert config.workflow_engine_dir == repo_root / "devin_orchestrator"
        assert config.session_work_dir == repo_root / "devin_orchestrator" / "work"
